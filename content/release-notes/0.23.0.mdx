...
Read through [Logs and Logging](/operation/adv-command-ref/#error-log-collection) section of our Utilities page for more information.
...
Read through our Developers Manual for more information.

- [Developing Connectors](https://docs.hummingbot.io/connectors/overview/)
- [Developing Strategies](https://docs.hummingbot.io/strategies/overview/)
...
- Added instructions in [Common ‘How To’ Questions](https://docs.hummingbot.io/intro/support/) on how to reset forgotten password, transferring files from/to WSL, and downloading a previous version of Hummingbot in Windows.
