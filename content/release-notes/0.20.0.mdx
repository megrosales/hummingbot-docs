...
- We have added a feature that allows you to encrypt and decrypt your exchange API keys. Please review `Step 3: Configure a market making bot` in our Quickstart guide for more details.

> Note : Quickstart guide has been removed from our new Docs site
...
- Added explanation in developer documentation for being specific when auto-completing exchange names.

> Note : This part has been removed on our new Docs site
